...
public class CustomProgressDialog {
     ...
     */
    public static CustomProgressDialog getInstance(Context ctx) {
        if (instance == null) {
     ...
     *
     * @param message for the progress dialog to display
     * @param iconRes for icon to be diaplayed in progress dialog.
     */
